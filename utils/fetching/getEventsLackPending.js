...
export const obtenerTodo = async (horaInicio, horaFinal) => {
  ...
  const responseTodas = await fetch(
    `https://api-v2.pasalo.pro/api/v2/community-tasks/pins?startDate=${horaInicio}&taskStatus[]=3528&taskType=3401&transfer=0&endDate=${horaFinalConMargenString}&customerId=593&communitiesIds[]=787&byCreation=`,
    {
      headers: {
